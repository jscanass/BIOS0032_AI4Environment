...
hist(locs$closed_lc_s)
hist(locs$closed_lc)
hist(locs$livestock_pressure_s)
hist(locs$livestock_pressure)
```
...
levels(locs$Conservancy)
unique(locs$Conservancy)
...
m1.1= glm(prop_detected ~ livestock_pressure_s + Conservancy -1, 
