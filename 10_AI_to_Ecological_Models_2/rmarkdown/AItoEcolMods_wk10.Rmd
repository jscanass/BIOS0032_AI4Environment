...
subtitle: 'Week 10'
author: "Rory Gibb, Ella Browning, Peggy Bevan"
date: "17/03/2025"
output: pdf_document
---
...
library(mgcv); library(gratia); library(lme4); library(terra) # only required for solutions
...
#complete for all other covariates in locs
...
Since there are only 4 levels, it was reasonable to include conservancy as a categorical fixed effect. An alternative, especially if there were a large number of conservancies, would be to design this as a **mixed effects (multilevel) model** and specify a *random intercept* for conservancy.
...
# summary - what is the effect of livestock?


# compare AICs - which model is better supported?
